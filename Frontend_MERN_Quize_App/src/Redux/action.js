...
export const getAllUserDataFromBackend = (payload) => (dispatch) => {
  ...
  axios
    .get("https://mern-quiz-app-mp2p.onrender.com/getuser")
    .then((res) => {
...
export const deleteUserByAdmin = (payload) => (dispatch) => {
  axios
    .delete(`https://mern-quiz-app-mp2p.onrender.com/${payload}`)
    .then((response) => {
...
export const postQuizObj = (obj) => (dispatch) => {
  axios
    .post("https://mern-quiz-app-mp2p.onrender.com/admin", obj)
    .then((res) => {
...
export const fetchQuizDataFrombackend = () => (dispatch) => {
  axios
    .get("https://mern-quiz-app-mp2p.onrender.com/api/quiz")
...
export const getQuiz = (params) => (dispatch) => {
  axios
    .get(`https://mern-quiz-app-mp2p.onrender.com/quiz/${params.id}`)
    .then((res) => {
...
export const postQuizResult = (obj) => (dispatch) => {
  ...
  axios
    .post(`https://mern-quiz-app-mp2p.onrender.com/userResult/${userId}`, obj)
    .then((res) => {
